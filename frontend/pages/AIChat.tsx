...
type Mode = 'speech-to-speech' | 'text-to-speech' | 'speech-to-text' | 'text-to-text';
...
const MODE_CONFIG = {
  'text-to-text': {
    label: 'Text to Text',
    description: 'Type and read the response',
    icon: '💬',
  },
  'speech-to-speech': {
...
export default function AIChat() {
  const [mode, setMode] = useState<Mode>('text-to-text');
...
function TextChatInterface({
  ...
  const showInput = mode === 'text-to-speech' || mode === 'speech-to-text' || mode === 'text-to-text';
