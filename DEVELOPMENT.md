...
```bash
git remote add encore encore://swiperight-credit-card-app-x4n2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/swiperight-credit-card-app-x4n2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/swiperight-credit-card-app-x4n2/settings/integrations/github)
